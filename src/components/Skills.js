  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="container max-w-screen-xl mx-auto min-h-screen text-white p-5 pt-20 flex justify-center items-center flex-col md:gap-10 md:p-10"
      >
        <div className="text-xl text-yellow-400 tracking-wider mb-4 animate-pulse">
          My Skills
        </div>
        <div className="skills-content flex flex-col justify-center items-center w-full gap-4 md:flex-row md:gap-10">
          <div
            className="core-technical-skills w-full p-5 rounded"
            style={{ backgroundColor: "#171717" }}
          >
            <div className="text-center text-lg tracking-wide font-semibold">
              Core Techical Skills
            </div>
                ...
                <div className="core-technical-skills-bar w-full flex flex-col py-1.5">
                  ...
                  <div className="skill-bar w-full h-2.5 rounded bg-white">
                    <motion.div
                      ...
                      className="skill-percent h-full bg-yellow-400 rounded "
                    ></motion.div>
                  </div>
                </div>
              );
          ...
          <div
            className="additional-skills w-full p-5 rounded"
            style={{ backgroundColor: "#171717" }}
          >
            <div className="text-center text-lg tracking-wide font-semibold">
              Additional Skills

...
function Skills() {
    ...
    return (
        <motion.div ref={ref}
            animate={controls}
            initial="hidden"
            variants={squareVariants} id="skills" className="container max-w-screen-xl mx-auto min-h-screen text-white p-5 pt-40 flex justify-center items-center flex-col md:gap-10 md:p-10">

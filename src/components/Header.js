...
function Header() {
    return (
        <div className="p-5 header-container max-w-screen-xl mx-auto flex justify-center items-center -m-16 h-screen max-h-screen text-white flex-col-reverse md:flex-row">
            <div className="header-content md:pl-10 flex flex-col items-center md:items-start space-y-5">
                ...
                <div className="flex">
                    ...
                    <a href="https://github.com/mondalraj" style={styles.headerButton} className="flex items-center mr-8 rounded"><img className="h-6 pr-3" src="https://img.icons8.com/material-outlined/50/ffffff/github.png" />Github</a>
                </div>
            </div>
